...
Snake<-setRefClass("Snake",contains="Game",
                   ...
                   methods=list(
                     ...
                     stage0=function(){
                       ...
                       text(0.5,0.4,label="任意键开始游戏",cex=2,col=4)
                       text(0.5,0.3,label="方向键控制方向",cex=2,col=2)
                       text(0.5,0.2,label="p键暂停",cex=2,col=1)
                     ...
                     stage2=function(){
                       callSuper()
                       info<-paste("") #结束界面不显示分数
                       print(info)
                       
                       plot(0,0,xlim=c(0,1),ylim=c(0,1),type='n',xaxs="i", yaxs="i")
                       text(0.5,0.7,label="Game Over",cex=5)
                       text(0.5,0.4,label="空格键重新开始，q退出",cex=2,col=4)
                       ...
                       if(stage==1){ #游戏中
                         ...
                         if(K == "q") stage2()
                           ...
                           if(tolower(K) %in% c("up","down","left","right")){
                             ...
                             e$dir<<-tolower(K)
                             stage1()  
                             text(0.5,0.9,label=paste("You have eat",nrow(e$tail),"fruits!"),cex=1,col=1)#游戏中显示分数
                           }
                         }
                         return(NULL)
                       }
